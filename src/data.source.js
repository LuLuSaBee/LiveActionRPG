  ...
  10002: {
    ...
    first: [
      ...
      },
      {
        line: '是我吹的，我吹的很好吧!!',
        options: [
          '呃\n還(好)不(難)錯(聽)，不對，我是來找畫作的，你有看到消失的蒙娜麗莎嗎？',
        ],
      },
      {
        line:
  ...
  10005: {
    ...
    answer: [
      ...
      [
        ...
        {
          line:
            '好啦好啦，我告訴你，可是你要先幫我把這副牌整理好，我前幾天跟秦始皇在打牌的時候不小心把牌弄亂了，到現在都還沒整理好，再不整理好秦始皇會把我殺掉的',
    ...
    gameSuccess: [
      ...
      {
        line:
          '對齁，真是抱歉，就是阿，我其實那天晚上有看到一個很奇怪的人，可是我沒有看清楚，館長室裡面有所有監視器的畫面，你可以去看看，搞不好會有更清楚的畫面。',
        options: ['館長室在哪裡啊？'],
      },
      {
